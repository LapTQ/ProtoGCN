graph = "coco_onlyhand"
work_dir = f"/home/laptq/ProtoGCN/runs/ProtoGCN/fs26/v86--mnit_poselift_roboflow_veo3misc--r1.38-0xauto-1x1--1s-15frames--v54-cyclic"
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file="/home/laptq/ProtoGCN/outputs/convert_pkl_STGCN_to_ProtoGCN/fs26/mnit_poselift_roboflow_veo3misc--r1.38-0xauto-1x1--1s-15frames/train.pkl",
