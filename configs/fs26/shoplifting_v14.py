modality = "j"
graph = "coco_onlyhand"
work_dir = f"/home/laptq/laptq-fs26-shoplifting-detection/runs/ProtoGCN_v14"
...
model = dict(
    ...
    cls_head=dict(
        ...
        in_channels=384,
        weight=0.2,
        loss_cls=dict(type='CrossEntropyLoss', loss_weight=1.0, class_weight=[0.01007079, 1.98992921]),
    ),
)
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file="/home/laptq/laptq-fs26-shoplifting-detection/outputs/convert_pkl_STGCN_to_ProtoGCN/train--mnit-poselift-roboflow-satudora--r10-0x0.5-1x10.pkl",
        pipeline=train_pipeline,
        split="train--mnit-poselift-roboflow-satudora--r10-0x0.5-1x10",
    ),
    val=dict(
        type=dataset_type,
