graph = "coco_onlyhand"
work_dir = f"/home/laptq/ProtoGCN/runs/ProtoGCN/fs26/v103--mnit_poselift_roboflow_satudora_awlrecord--r1.0-0xauto-1x1--no-normal-awlrecord--equal-normal-public-vs-satudora--1s-15frames--fixR10"
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file="/home/laptq/ProtoGCN/outputs/convert_pkl_STGCN_to_ProtoGCN/fs26/mnit_poselift_roboflow_satudora_awlrecord--r1.0-0xauto-1x1--no-normal-awlrecord--equal-normal-public-vs-satudora--1s-15frames/train.pkl",
