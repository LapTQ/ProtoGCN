graph = "coco_onlyhand"
work_dir = f"/home/laptq/ProtoGCN/runs/ProtoGCN/fs26/v105--mnit_poselift_roboflow_satudora_awlrecord--r1.0-0xauto-1x1--only-normal-satudora-filter-roi-conf--1s-15frames"
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file="/home/laptq/ProtoGCN/outputs/convert_pkl_STGCN_to_ProtoGCN/fs26/mnit_poselift_roboflow_satudora_awlrecord--r1.0-0xauto-1x1--only-normal-satudora-filter-roi-conf--1s-15frames/train.pkl",
