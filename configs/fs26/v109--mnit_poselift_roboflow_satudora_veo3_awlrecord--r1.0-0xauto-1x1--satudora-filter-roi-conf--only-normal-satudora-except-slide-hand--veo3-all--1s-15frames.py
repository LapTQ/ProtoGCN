graph = "coco_onlyhand"
work_dir = f"/home/laptq/ProtoGCN/runs/ProtoGCN/fs26/v109--mnit_poselift_roboflow_satudora_veo3_awlrecord--r1.0-0xauto-1x1--satudora-filter-roi-conf--only-normal-satudora-except-slide-hand--veo3-all--1s-15frames"
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file="/home/laptq/ProtoGCN/outputs/convert_pkl_STGCN_to_ProtoGCN/fs26/mnit_poselift_roboflow_satudora_veo3_awlrecord--r1.0-0xauto-1x1--satudora-filter-roi-conf--only-normal-satudora-except-slide-hand--veo3-all--1s-15frames/train.pkl",
