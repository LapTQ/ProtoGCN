modality = "j"
graph = "coco_onlyhand"
work_dir = f"/home/laptq/laptq-fs26-shoplifting-detection/runs/ProtoGCN_v18"
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file="/home/laptq/laptq-fs26-shoplifting-detection/outputs/convert_pkl_STGCN_to_ProtoGCN/train--mnit-poselift-roboflow-satudora--r2-0x1-1x99.pkl",
        pipeline=train_pipeline,
        split="train--mnit-poselift-roboflow-satudora--r2-0x1-1x99",
    ),
    val=dict(
        type=dataset_type,
