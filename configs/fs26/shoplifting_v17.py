modality = "j"
graph = "coco_onlyhand"
work_dir = f"/home/laptq/laptq-fs26-shoplifting-detection/runs/ProtoGCN_v17"
...
model = dict(
    ...
    cls_head=dict(
        ...
        in_channels=384,
        weight=0.2,
        loss_cls=dict(type='CrossEntropyLoss', loss_weight=1.0, class_weight=[0.01005545, 1.98994455]),
    ),
)
