graph = "coco_onlyhand"
work_dir = f"/home/laptq/laptq-fs26-shoplifting-detection/runs/ProtoGCN/fs26/v79--mnit_poselift_roboflow_satudora_veo3misc_awlrecord--r2.0-0xauto-1x1--1s-15frames"
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file="/home/laptq/laptq-fs26-shoplifting-detection/outputs/convert_pkl_STGCN_to_ProtoGCN/fs26/mnit_poselift_roboflow_satudora_veo3misc_awlrecord--r2.0-0xauto-1x1--1s-15frames/train.pkl",
