graph = "coco_headless"
work_dir = f"/home/laptq/laptq-fs26-shoplifting-detection/runs/ProtoGCN/fs26/v211--satudora_veo3_awlrecord--split-14-class--nodistinct--max4769--12-kpts--recall"
...
evaluation = dict(interval=1, metrics=["recall_macro"], greater_keys=["recall_macro"], class_map=None)
