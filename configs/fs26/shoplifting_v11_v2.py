modality = "j"
graph = "coco_onlyhand"
work_dir = f"/home/laptq/laptq-fs26-shoplifting-detection/runs/ProtoGCN_v11_v2"
...
model = dict(
    ...
    cls_head=dict(
        ...
        in_channels=384,
        weight=0.2,
        loss_cls=dict(type='CrossEntropyLoss', loss_weight=1.0, class_weight=[0.00995098, 1.99004902]),
    ),
)
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file="/home/laptq/laptq-fs26-shoplifting-detection/outputs/convert_pkl_STGCN_to_ProtoGCN/train--mnit-poselift-roboflow-satudora--r200-0x1-1x1.pkl",
        pipeline=train_pipeline,
        split="train--mnit-poselift-roboflow-satudora--r200-0x1-1x1",
    ),
    val=dict(
        type=dataset_type,
