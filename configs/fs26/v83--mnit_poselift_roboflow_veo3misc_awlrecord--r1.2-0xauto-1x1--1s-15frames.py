graph = "coco_onlyhand"
work_dir = f"/home/laptq/laptq-fs26-shoplifting-detection/runs/ProtoGCN/fs26/v83--mnit_poselift_roboflow_veo3misc_awlrecord--r1.2-0xauto-1x1--1s-15frames--cyclic"
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file="/home/laptq/laptq-fs26-shoplifting-detection/outputs/convert_pkl_STGCN_to_ProtoGCN/fs26/mnit_poselift_roboflow_veo3misc_awlrecord--r1.2-0xauto-1x1--1s-15frames/train.pkl",
...
lr_config = dict(policy="Cyclic", by_epoch=False, target_ratio=(10000, 0.001), cyclic_times=10, step_ratio_up=0.0000001, anneal_strategy='cos')
total_epochs = 100
