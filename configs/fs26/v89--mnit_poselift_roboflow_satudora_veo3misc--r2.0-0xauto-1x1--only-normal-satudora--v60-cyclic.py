graph = "coco_onlyhand"
work_dir = f"/home/laptq/ProtoGCN/runs/ProtoGCN/fs26/v89--mnit_poselift_roboflow_satudora_veo3misc--r2.0-0xauto-1x1--only-normal-satudora--v60-cyclic--fixR10"
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file="/home/laptq/ProtoGCN/outputs/convert_pkl_STGCN_to_ProtoGCN/fs26/mnit_poselift_roboflow_satudora_veo3misc--r2.0-0xauto-1x1--only-normal-satudora/train.pkl",
