graph = "coco_onlyhand"
work_dir = f"/home/laptq/ProtoGCN/runs/ProtoGCN/fs26/v95--mnit_poselift_roboflow_satudora_veo3misc_awlrecord--r1.11-0xauto-1x1--only-normal-satudora--1s-15frames--fixR10"
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file="/home/laptq/ProtoGCN/outputs/convert_pkl_STGCN_to_ProtoGCN/fs26/mnit_poselift_roboflow_satudora_veo3misc_awlrecord--r1.11-0xauto-1x1--only-normal-satudora--1s-15frames/train.pkl",
